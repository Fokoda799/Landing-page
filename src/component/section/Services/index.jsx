...
import { PhotoChatMessage, VideoBar, VideoChatMessage } from '../../designs/Services'
import { Gradient } from '../../designs/Services'
      ...
      <div className="container">
        ...
        <div className="relative">
          <div 
            ...
            p-8 border border-n-1/10 rounded-3xl overflow-hidden
            lg:p-20 xl:h-[46rem]"  
          >
            <div 
              className="absolute top-0 left-0 w-full h-full
              pointers-events-none md:w-3/5 xl:w-auto"
            >
              <img 
          ...
          >
            ...
            >
              ...
              <div
                ...
                justify-end p-8 bg-linear-to-b from-n-8/0
                to-n-8/90 xl:p-15"
              >
